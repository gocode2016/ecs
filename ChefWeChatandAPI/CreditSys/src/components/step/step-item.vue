...
<div class="vux-step-item" :class=" { 'vux-step-item-with-tail' : !currentStepLast} ">
  <div :class="'vux-step-item-tail ' + 'vux-step-item-tail-' + currentStatus" v-show="!currentStepLast" :style="{right: 0}"></div>
  <div :class="'vux-step-item-head ' + 'vux-step-item-head-' + currentStatus">
    <div class="vux-step-item-head-inner">
      <span v-if="!icon && currentStatus!='finish'" class="vux-step-item-icon"><span class="vuxCircle"></span></span>
