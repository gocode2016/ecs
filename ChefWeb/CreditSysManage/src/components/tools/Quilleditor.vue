    ...
    export default {
        ...
        methods: {
            ...
            onFileChange(e){
              ...
              data.append(this.fileName, fileInput.files[0],fileInput.files.name);
             // console.log(this.uploadUrl)
              var type =this.uploadUrl.split('img_type=')[1]+'/'; 
              $.ajax({
		           type : 'post',
		           url : this.uploadUrl,
		           data : data,
		           ...
		           success : function(json){
		           	//console.log(type)
		           	//var dataAll =  URLHeader.Tools+'/UploadFiles/Product/'+JSON.parse(json).Id+'.'+JSON.parse(json).Type;
		           	var dataAll =  URLHeader.Loading+'/'+type+JSON.parse(json).Id+'.'+JSON.parse(json).Type;
		           	console.log(dataAll)
		           	 self.editor.focus();
           		  	 self.editor.insertEmbed(self.editor.getSelection().index, 'image', dataAll);
		           },
		           error : function(){ }
		       })
