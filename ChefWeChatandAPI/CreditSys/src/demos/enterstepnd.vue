<template>
  <div class="enterstepnd">
    ...
    <!--备料展示-->
     ...
     <p class="add"><img src="../../static/credit/jia.png" @click="add('1')"/></p>
     <!--辅料-->
     <p class="zliao">辅料</p>
     <ul class="access">
     	 <li>
     ...
     <p class="add"><img src="../../static/credit/jia.png" @click="add('2')"/></p>
      <!--调料-->
     <p class="zliao">调料</p>
     ...
     <div class="alike show">
	   ...
	   <ul class='cookStep'>
	   	 <li>
		   	 	<span>1、</span> 	   	 
	        <textarea  placeholder="添加步骤说明"></textarea>	       
	        <img src="../../static/credit/jian.png" class="rem"/>
	   	 </li>
	   </ul>
	   <p class="add"><img src="../../static/credit/jia.png" @click="add4"/></p>
	   <!--按钮-->
	   <div class="btnDiv"><button @click="save">保存</button><button @click="nextStep">下一步</button></div>
	   <!--信息不完整提示-->
...
export default {
  ...
  methods:{
    add(num){
    		var li=$('<li data-v-c1a7e852><input data-v-c1a7e852 class="maintext" type="text"><input data-v-c1a7e852 class="weight" type="text"><span data-v-c1a7e852 class="ke">g&nbsp;</span><img data-v-c1a7e852 src="../../static/credit/jian.png" class="rem"/></li>');  
    		if(num=='1'){//添加主料
    			$('.main').append(li);	
    		}else if(num=='2'){//添加辅料
    			$('.access').append(li);	
    ...
    onItemClick(text,value){//添加调料
      if(flag[value]==0){
      	var li=$('<li data-v-c1a7e852 class='+value+'><input data-v-c1a7e852 class="maintext" type="text" value='+text+'  readonly="readonly"><input data-v-c1a7e852 class="weight" type="text"><span data-v-c1a7e852>g&nbsp;</span><img data-v-c1a7e852 src="../../static/credit/jian.png" class="rem"/></li>');
        $('.season').append(li);
        flag[value]=1;
      }else{
      	$('.'+value+'').remove();
    ...
    add3(){//添加其他调料
    		var li=$('<li data-v-c1a7e852><input data-v-c1a7e852 class="maintext" type="text"><input data-v-c1a7e852 class="weight" type="text"><span data-v-c1a7e852>g&nbsp;</span><img data-v-c1a7e852 src="../../static/credit/jian.png" class="rem"/></li>');  
    	  $('.othersea').append(li);	
    },
    add4(){//添加烹饪步骤
    	var length=$('.cookStep li').length+1;
    	var li=$('<li data-v-c1a7e852><span data-v-c1a7e852>'+length+'、</span><textarea data-v-c1a7e852 placeholder="添加步骤说明"></textarea><img data-v-c1a7e852 src="../../static/credit/jian.png" class="rem"/></li>')
    	$('.cookStep').append(li);	
    },
    nextStep(){//下一步
    	if(this.dishName==''){
    		...
    		this.$router.push({path:'/component/entersteprd'})
    	}    	
    },
    menuBtn(){
    	this.flag2=false;
...
<style>
  ...
  .enterstepnd .weui-textarea{font-size: 13px !important;text-indent: 1em;}
  .enterstepnd .vux-no-group-title:before{border-top: none !important;}
  .enterstepnd .vux-no-group-title:after{border-bottom: none !important;}
  .enterstepnd .weui-cells{margin-top: 0 !important;}
  
  .enterstepnd .vux-step{width: 76%;margin-left: 12%;}
