<template>
	<div class="VirtualGoodsAdd">
		<Spin fix class='loding'>
        		<Icon type="load-c" size=18 class="demo-spin-icon-load"></Icon>
        <div>Loading</div>
        </Spin>
		<h1 style="text-align: center;margin: 0rem auto;margin-top: 1rem;">虚拟商品添加</h1>
...
//				editorOption:{},
		...
		methods:{
            ...
            saveAlldata(){//整体保存
					...
					if (self.GoodsInformation.ImgUrl=='../../../../../static/image/placeholderBag.png') {//图片为空
						...
						if (self.GoodsInformation.CategoryId!=null && self.GoodsInformation.ProductPrice &&self.GoodsInformation.ProductContent  && self.GoodsInformation.ProductName) {
							console.log('信息完整')
		...
		mounted:function(){
			...
			$('.loding').hide()
//			$('.VirtualGoodsAdd ul .GoodsAddli .ivu-select-placeholder').css({
//				'display':'block'
//			})
		}
	}
...
.VirtualGoodsAdd .ql-container{
	height: 80%;
}
.VirtualGoodsAdd .quill-editor{
	height: 22rem;
}
.VirtualGoodsAdd .rtf-content .ql-toolbar .ql-video{
	display: none;
}
</style>
<style scoped>
